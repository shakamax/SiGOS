      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="NovaOS.jsp">Nova Ordem de Serviço</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseFunc" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="listaFuncionarios.jsp">Todos Funcionários</a>
            <a class="collapse-item" href="novoFuncionario.jsp">Novo Funcionário</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseServ" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="listaServicos.jsp"> Lista Serviços </a>
            <a class="collapse-item" href="novoServico.jsp"> Novo Serviço </a>
          </div>
        </div>
      </li>
